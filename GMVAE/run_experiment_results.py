...
path  = '/home/srinath/Project/CSC413_Project/ClusterVAE/runs/cifar10'
dir_names = [os.path.join(path, '900epoch_z50_vae_vanilla_bs128_cifar_k4_gaussian_data_div_1channel'),
            os.path.join(path, '900epoch_z50_vae_vanilla_bs128_cifar_k4_gaussian_data_div_1channel_lr_5e_3_lr_decay')]
